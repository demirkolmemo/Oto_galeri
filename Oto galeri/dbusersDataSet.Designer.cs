...
namespace Oto_galeri {
    ...
    public partial class dbusersDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public usersRow AddusersRow(string username, string password, string email, string ad_soyad) {
        ...
        public partial class usersRow : global::System.Data.DataRow {
            ...
            public string ad_soyad {
                get {
                    try {
                        return ((string)(this[this.tableusers.ad_soyadColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'ad_soyad\' в таблице \'users\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableusers.ad_soyadColumn] = value;
                }
            }
            ...
            public bool Isad_soyadNull() {
                return this.IsNull(this.tableusers.ad_soyadColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void Setad_soyadNull() {
                this[this.tableusers.ad_soyadColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Oto_galeri.dbusersDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `users` WHERE ((`username` = ?) AND ((? = 1 AND `password` IS NULL) O" +
                "R (`password` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)) AND ((? =" +
                " 1 AND `ad_soyad` IS NULL) OR (`ad_soyad` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `users` (`username`, `password`, `email`, `ad_soyad`) VALUES (?, ?, ?" +
                ", ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `users` SET `username` = ?, `password` = ?, `email` = ?, `ad_soyad` = ? WHERE ((`username` = ?) AND ((? = 1 AND `password` IS NULL) OR (`password` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)) AND ((? = 1 AND `ad_soyad` IS NULL) OR (`ad_soyad` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Oto_galeri.Properties.Settings.Default.dbusersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, [password], email, ad_soyad FROM users";
        ...
        public virtual int Fill(dbusersDataSet.usersDataTable dataTable) {
        ...
        public virtual dbusersDataSet.usersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbusersDataSet.usersDataTable dataTable = new dbusersDataSet.usersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbusersDataSet.usersDataTable dataTable) {
        ...
        public virtual int Delete(string Original_username, string Original_password, string Original_email, string Original_ad_soyad) {
        ...
        public virtual int Insert(string username, string password, string email, string ad_soyad) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, string email, string ad_soyad, string Original_username, string Original_password, string Original_email, string Original_ad_soyad) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string email, string ad_soyad, string Original_username, string Original_password, string Original_email, string Original_ad_soyad) {
            return this.Update(Original_username, password, email, ad_soyad, Original_username, Original_password, Original_email, Original_ad_soyad);
        }
    }
